...
const instructionsData = [
  {
    ...
    content: "Start by entering the name of your vacation destination in the search bar to get up-to-date weather conditions.",
  },
  {
    heading: "View Weather Details",
    content: "Check detailed weather information, including temperature, humidity, wind speed, and a forecast for the upcoming days.",
  },
  {
    heading: "Save Your Favorite Locations",
    content: "Found a place you like? Save it to your favorites by clicking the star icon, so you can easily check the weather anytime.",
  },
  {
    heading: "Manage Your Favorites",
    content: "Access your saved locations from the favorites section, where you can remove, view, or organize your preferred destinations.",
  },
];
